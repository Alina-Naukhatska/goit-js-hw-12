import{a as g,S as h,i as a}from"./assets/vendor-pJyzcLlr.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(e){if(e.ep)return;e.ep=!0;const i=s(e);fetch(e.href,i)}})();const y="46876672-e8b342777c96e71d5bef3ef8d",p="https://pixabay.com/api/";async function v(t,r){return(await g.get(p,{params:{key:y,q:t,image_type:"photo",orientation:"horizontal",safesearch:!0,page:r,per_page:15}})).data.hits}function L(){const t=document.getElementById("gallery");t.innerHTML=""}function b(t){const r=document.getElementById("gallery"),s=t.map(E).join("");r.insertAdjacentHTML("beforeend",s)}function E({likes:t,views:r,comments:s,downloads:o,webformatURL:e,largeImageURL:i}){return`
